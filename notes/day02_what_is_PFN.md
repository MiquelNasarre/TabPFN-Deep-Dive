...
that much to it. Lets follow the data from input to output so see what it actually does 
(did in 2023).
...
last two columns are set to 0 for unknown label.
...
... it is a bit late so I will finish day 2 tomorrow :)
